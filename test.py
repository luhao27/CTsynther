...
from ctsynther.utils.translate_utils import translate_batch_original, translate_batch_search_strategy
...
parser.add_argument('--search_strategy', type=str, default=False, choices=['True', 'False'], help='')
    ...
    for batch in tqdm(iterator, total=len(iterator)):
        ...
        if args.search_strategy == 'False':
            ...
            pred_tokens, pred_scores, predicts = \
                translate_batch_search_strategy(model, batch, beam_size=args.beam_size,
                                         invalid_token_indices=invalid_token_indices,
...
def main(args):
    ...
    # Get Output Path:
    dec_version = 'search_strategy' if args.search_strategy == 'True' else 'vanilla'
